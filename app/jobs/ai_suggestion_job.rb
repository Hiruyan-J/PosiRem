class AiSuggestionJob < ApplicationJob
  ...
  def build_prompt(original_text)
    ...
    prompt = <<-PROMPT
      ...
      幼児に向けて、禁止の言葉ではなく「実際にやってほしい行動」や「実際にやってほしい行動を子供がやることが前提の選択肢を子供に与える言葉」に言い換えて伝えてください。
      大切なのは、子どもが安心して行動できるようにポジティブでわかりやすい言葉にすることです。
      また、幼児が楽しくイメージできるように「動物」「ヒーロー」「忍者」「キャラクター」「身近なもの」などの分かりやすい例えを入れることもできますが、
      ...
      「お風呂に入って」→「今日は、お風呂でおもちゃのアヒルさんと遊ぶ？それともお船で遊ぶ？」
