...
子育て中に「走らないで！」「触っちゃダメ！」など、つい禁止語やネガティブな表現を使ってしまうことがりませんか？しかし、子どもには**肯定的な言葉**のほうが伝わりやすいと言われています。

**PosiRem!** は、保護者が入力したネガティブ・禁止的な表現を AI（OpenAI GPT-4o-mini）が分析し、子どもに伝わるポジティブな表現に変換するアプリです。
...
| インフラ | Render.com |
| CI/CD | GitHub Actions（Brakeman / RuboCop / RSpec） |
